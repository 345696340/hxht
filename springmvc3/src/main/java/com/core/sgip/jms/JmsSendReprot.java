...
/*    */ 
/*    */ public class JmsSendReprot
/*    */ {
/*    */   MessageProducer producer;
/*    */   Session session;
/*    */ 
/*    */   public JmsSendReprot(Report report)
/*    */   {
...
/*    */ 
/* 41 */       Destination destination = this.session.createQueue("SmsReportUpQueue");
/*    */ 
/* 43 */       this.producer = this.session.createProducer(destination);
/*    */ 
/* 47 */       sendMessage(report);
...
/*    */   }
/*    */ 
/*    */   private void sendMessage(Report report) throws Exception {
/* 63 */     ObjectMessage message = this.session.createObjectMessage();
/*    */ 
/* 65 */     message.setObject(report);
/* 66 */     this.producer.send(message);
/*    */   }
/*    */ }

/* Location:           D:\com.sms.sgip-2.0-beta-7.jar
 * Qualified Name:     com.core.sgip.jms.JmsSendReprot
